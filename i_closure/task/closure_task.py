...
def set_user():
    ...
    def insert(name):
        # closure에서도 global 키워드 사용하면, 전역변수 사용 가능하다.
        global number
        number += 1
    ...
    return {'insert': insert, 'select': select, 'select_all': select_all, 'update': update, 'delete': delete}
...
# post_service.get('insert')(title='테스트 제목6', content='테스트 내용6', file='/usr/post/file/img006.png')
# print(post_service.get('select')(6))
# print(post_service.get('select_all')())
# print(post_service.get('read')(3))
# # print(post_service.get('read')(3))
# # print(post_service.get('read')(3))
# post = post_service.get('read')(3)
# post['title'] = '수정된 제목'
# # print(post)
# print(post_service.get('select')(3))
# post_service.get('update')(**post)
# print(post_service.get('read')(3))
# post_service.get('delete')(3)
# print(post_service.get('select_all')())
