...
# datas_copy = datas  # True
# print(datas is datas_copy)
datas_copy[0] = 10
print(datas)       # [1, 2, 3]
print(datas_copy)   # [10, 2, 3]
...
datas_copy = copy.copy(datas)
datas_copy[0] = 10
print(datas)       # [1, [1, 2, 3], [4, 5, 6]]
print(datas_copy)   # [10, [1, 2, 3], [4, 5, 6]]

# 얕은 복사
datas_copy[1][0] = 10
print(datas)       # [10, [10, 2, 3], [4, 5, 6]]
print(datas_copy)   # [10, [10, 2, 3], [4, 5, 6]]
...
datas_copy[1][0] = 10
print(datas)       # [1, [1, 2, 3], [4, 5, 6]]
print(datas_copy)   # [1, [10, 2, 3], [4, 5, 6]]